...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Location">
      ...
      <sch:assert test="count(f:extension[@url = 'https://interop.esante.gouv.fr/ig/fhir/ror24/StructureDefinition/ror-code-region']) &lt;= 1">extension with URL = 'https://interop.esante.gouv.fr/ig/fhir/ror24/StructureDefinition/ror-code-region': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    ...
    <sch:rule context="f:Location/f:address">
      ...
      <sch:assert test="count(f:extension[@url = 'https://interop.esante.gouv.fr/ig/fhir/ror24/StructureDefinition/ror-commune-cog']) &lt;= 1">extension with URL = 'https://interop.esante.gouv.fr/ig/fhir/ror24/StructureDefinition/ror-commune-cog': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Location/f:position">
      <sch:assert test="count(f:extension[@url = 'https://interop.esante.gouv.fr/ig/fhir/ror24/StructureDefinition/ror-location-geodesic-system']) &gt;= 1">extension with URL = 'https://interop.esante.gouv.fr/ig/fhir/ror24/StructureDefinition/ror-location-geodesic-system': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interop.esante.gouv.fr/ig/fhir/ror24/StructureDefinition/ror-location-geodesic-system']) &lt;= 1">extension with URL = 'https://interop.esante.gouv.fr/ig/fhir/ror24/StructureDefinition/ror-location-geodesic-system': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interop.esante.gouv.fr/ig/fhir/ror24/StructureDefinition/ror-location-reliable-position']) &lt;= 1">extension with URL = 'https://interop.esante.gouv.fr/ig/fhir/ror24/StructureDefinition/ror-location-reliable-position': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
