Instance: ror-healthcareservice-psychiatric-sector
...
* type = #string
* expression = "HealthcareService.extension.where(url = 'http://esante.gouv.fr/ci-sis/fhir/StructureDefinition/ror-healthcareservice-psychiatric-sector').valueString"