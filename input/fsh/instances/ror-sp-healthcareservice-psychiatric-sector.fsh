...
* type = #string
* expression = "HealthcareService.extension.where(url = 'https://interop.esante.gouv.fr/ig/fhir/ror24/StructureDefinition/ror-healthcareservice-psychiatric-sector').valueString"