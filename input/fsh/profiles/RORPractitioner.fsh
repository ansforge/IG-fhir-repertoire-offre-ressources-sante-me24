...
//* telecom.extension[ror-confidentiality-level] ^sliceName = "ror-confidentiality-level" dans le json min=1 et n'apparait pas dans le fsh?
* telecom.extension[ror-confidentiality-level] ^isModifier = false
//* telecom.extension[ror-communication-channel] only RORCommunicationChannel dans le json min=1 et n'apparait pas dans le fsh ?
